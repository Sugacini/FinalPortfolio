        ...
        (isVisible == true ?
            <div className="otherProjectInner">
                {(text == "Scratch" ? <>
                    ...
                    <SingleSkill className="project" image="chat.jpg" className1="projectImg1" text="Chat" className2="projectName1" className3="insideImg" link="http://localhost:3700/" btnClass="btn1"></SingleSkill>
