        ...
        (isVisible == true ?
            <div className="otherProjectInner">
                {(text == "Scratch" ? <>
                    ...
                    <SingleSkill className="project" image="balloonPop.jpg" className1="projectImg1" text={Scratch[0].name1} className2="projectName1" className3="insideImg" link="https://scratch.mit.edu/projects/1040052213/fullscreen/" btnClass="btn1"></SingleSkill>
                    <SingleSkill className="project" image="fish.jpg" className1="projectImg1" text={Scratch[0].name2} className2="projectName1" className3="insideImg" link="https://scratch.mit.edu/projects/1034193201/fullscreen/" btnClass="btn1"></SingleSkill>
                    <SingleSkill className="project" image="emojies.jpg" className1="projectImg1" text={Scratch[0].name3} className2="projectName1" className3="insideImg" link="https://scratch.mit.edu/projects/1036376695/fullscreen/" btnClass="btn1"></SingleSkill>
                </> : text == "Html/Css" ? <>
                    <SingleSkill className="project" image="vortex.png" className1="projectImg1" text="Vortex" className2="projectName1" className3="insideImg" link="https://sugacinil-3357-8443.zcodeusers.in/assignment_015/vertex.html" btnClass="btn1"></SingleSkill>
                    <SingleSkill className="project" image="cube2.jpg" className1="projectImg1" text="Cube" className2="projectName1" className3="insideImg" link="https://sugacinil-3357-8443.zcodeusers.in/assignment_022/cube.html" btnClass="btn1"></SingleSkill>
                    <SingleSkill className="project" image="lorem.png" className1="projectImg1" text="Lorem" className2="projectName1" className3="insideImg" link="https://sugacinil-3357-8443.zcodeusers.in/assignment_025/" btnClass="btn1"></SingleSkill>
                    ...
                    <SingleSkill className="project" image="logo4.jpg" className1="projectImg1" text="My Project" className2="projectName1" className3="insideImg" btnClass="btn1"></SingleSkill>
                    <SingleSkill className="project" image="sumplete.png" className1="projectImg1" text="Sumplete/Bingo" className2="projectName1" className3="insideImg" link="https://sugacinil-3357-8443.zcodeusers.in/sumplete/" btnClass="btn1"></SingleSkill>
                    ...
                    <SingleSkill className="project" image="planets.png" className1="projectImg1" text="Planets" className2="projectName1" className3="insideImg" link="https://planets-1-qavj.onrender.com" btnClass="btn1"></SingleSkill>
